...
const COVERAGE: Record<RouteKey, Call> = {
  ...
  "GET /v1/documents/balance": (ob) => ob.documents.balance(),
  "GET /v1/documents/batch": (ob) => ob.documents.batch("b1"),
  "GET /v1/documents/fees": (ob) => ob.documents.fees(),
  "GET /v1/documents/jobs/file": (ob) => ob.documents.jobFile("j1"),
  "GET /v1/documents/ledger": (ob) => ob.documents.ledger(),
  "GET /v1/documents/link": (ob) => ob.documents.link("l1"),
  "GET /v1/documents/referrals": (ob) => ob.documents.referrals(),
  "GET /v1/documents/split": (ob) => ob.documents.split(),
  ...
  "GET /v1/documents/{kind}/{id}": (ob) => ob.documents.get("invoice", "i1"),
  ...
  "POST /v1/api-allowlist/list": (ob) => ob.settings.getApiAllowlist(),
  ...
  "POST /v1/wallet/blocked-address-refund": (ob) =>
    ob.wallets.refundBlocked({ uuid: "w1", address: "T" }),
